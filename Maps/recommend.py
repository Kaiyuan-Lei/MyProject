...
def group_by_centroid(restaurants, centroids):
    ...
    clusters = [[centroid(r), r] for r in restaurants]
...
def find_centroid(cluster):
    ...
    # BEGIN Question 5
    def lat(cluster):
        return [restaurant_location(i)[0] for i in cluster]
    def lon(cluster):
        return [restaurant_location(i)[1] for i in cluster]
...
def best_predictor(user, restaurants, feature_fns):
    ...
    # BEGIN Question 8
    predictors = {find_predictor(user, reviewed, feature_fn)[0]: find_predictor(user, reviewed, feature_fn)[1] for feature_fn in feature_fns}
